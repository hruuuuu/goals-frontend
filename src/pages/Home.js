      ...
      <div className="l-home">
        <div className="l-home__key-vision">
          <div className="c-swiper c-swiper--kv">
            ...
            <button type="button" className="c-scroll-indicator">
              SCROLL
            </button>
          ...
          <div className="container">
                        ...
                        return (
                          <div key={id} className="col-3">
                            <div className="c-overview__item">
                              ...
                              <p className="c-overview__description">
                                {description}
                              </p>
                            </div>
                          </div>
            ...
            <div className="l-home__product c-section">
              <div className="row justify-content-center">
                <div className="col-12 col-xl-10">
                  <div
                    className="row gx-0 c-section__row"
                          ...
                          {productItems.map((item) => {
                            ...
                            return (
                              <li key={id} className="c-section__item">
                                <div className="c-section__list-num">{id}</div>
