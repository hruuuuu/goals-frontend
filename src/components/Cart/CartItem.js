  ...
  return (
    <>
      ...
      {/* <div className="container">
        <div className="row cartItem__thead justify-content-between align-items-center">
        ...
        <div className="row cartItem__body justify-content-between align-items-center">
          <div className="col">
            <div className="cartItem__cover">
              <img
                className="cartItem__img"
